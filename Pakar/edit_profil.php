        ...
        if (empty($nama) || empty($username)) {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($updateProfile->execute()) {
                    ...
                    // Update data pakar untuk ditampilkan
                    $pakar['nama'] = $nama;
                    $pakar['username'] = $username;
                } else {
...
<html lang="id">
    <head>
        ...
        <title>Edit Profil Pakar - Sistem Pakar</title>
    ...
    <body class="bg-gray-50 text-gray-800">
        ...
        <div class="max-w-2xl mx-auto px-4 py-6">
            <div class="flex items-center mb-6">
                <h1 class="text-2xl font-semibold">Edit Profil Pakar</h1>
            </div>
                ...
                <form method="POST" class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" 
                               value="<?= htmlspecialchars($pakar['nama']) ?>"
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" 
                               value="<?= htmlspecialchars($pakar['username']) ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-purple-500 focus:border-purple-500"
                               required>
                    </div>
